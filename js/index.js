...
function init() {
  ...
  exp.catch_trials = [];
    ...
    /*{sentence: "Pero el águila, despreciando la insignificancia del escarabajo, devoró a la liebre en su presencia."},
    {sentence: "Desde entonces, buscando vengarse, el escarabajo observaba los lugares donde el águila ponía sus huevos, y haciéndolos rodar, los tiraba a tierra. "},
    {sentence: "Viéndose el águila echada del lugar a donde quiera que fuera, recurrió a Zeus pidiéndole un lugar seguro para depositar sus huevos."},
    {sentence: "Le ofreció Zeus colocarlos en su regazo, pero el escarabajo, viendo la táctica escapatoria, hizo una bolita de estiércol, voló y la dejó caer sobre el regazo de Zeus."},
    {sentence: "Se levantó entonces Zeus para sacudirse aquella suciedad, y tiró por tierra los huevos sin darse cuenta." },
    {sentence: "Por eso desde entonces, las águilas no ponen huevos en la época en que salen a volar los escarabajos."},
    {sentence: "Nunca desprecies lo que parece insignificante, pues no hay ser tan débil que no pueda alcanzarte."}]*/
